...
- 他のネットワークスイッチへの反映を行うこと
- ProxmoxおよびネットワークカードはFirewallが送受信したパケットのリカバリーを行うこと
　特に送信中に別ノードに引き継がれ、新しいノードのNICからすれば、いきなり何も知らないところでFirewallからの送信データを受ける、また外部から仮想Macアドレス宛の中途半端な受信データを受けることになります。単純にTCPの世界で再送も入りますが、仮想環境とNIC側それぞれの腕の見せ所です。
- クライアント側のTCPレイヤのリカバリ。ロストしたパケットを再送要求すること

厳密に言えば、この操作はMacBookからWi-Fi経由で操作しているので、そこも含めてスムーズな切り替わりが行えていることになります。
