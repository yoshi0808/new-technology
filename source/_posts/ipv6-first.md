...
可用性としては優れた仕組みですが、IPv4の国別フィルタで意図的に宛先国をブロックする運用をしている場合、IPv6の国別フィルタの機能がFirewallに無ければセキュリティリスクに見えます。本来はWebレピュテーションやIPレピュテーションで防御すべきでしょうけれども、このあたりの挙動も頭の片隅に置いておいたほうが良さそうです。
