...
（2022-11-23追記）
ESXiの最新Versionは2022-10-11に発表された8.0となっています。まだ無償版としてのライセンスが提供されていないようです。もう少し成熟してから無償版のライセンスが提供開始になるのでしょうか。まだ状況は不明瞭であり、この記事ではESXi7を対象にしています。新しいバージョンでは新しいハードウェアに適合する一方、古いCPUやネットワークカードなどは切り捨てられる傾向があります。
