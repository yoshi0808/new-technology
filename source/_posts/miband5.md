...
Runkeeperは、[Withingsの体重計](https://www.withings.com/jp/ja/scales)と連携でき、RunkeeperのPCサイトでは運動と体重の推移が確認できますので、自身の健康管理にも役立ちます。Withingsの体重計のデータはWi-FiでWithingsのクラウドに自動アップロードされるため、とても便利です。

なお、心拍数とゾーンの関係についてのもう少し詳細な説明は、[こちらの記事](https://earnest.fit/intensity-aerobic-exercise/)をご覧ください。iOS限定ではありますが、RunkeeperからAppleヘルスケアにデータ連携させておけば、その後、Zonesというアプリを利用する事でゾーン毎の運動時間を把握できます。
